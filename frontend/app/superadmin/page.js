    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Link href="/superadmin/nagar-sevak" className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <h2 className="text-xl font-bold text-gray-800">Manage Nagar Sevaks</h2>
                <p className="text-gray-500 mt-2">View, edit, or add corporators for various wards.</p>
                <span className="inline-block mt-4 text-indigo-600 font-semibold group-hover:translate-x-1 transition-transform">Configure Officers →</span>
            </Link>

            <Link href="/superadmin/complaints" className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all">
                ...
                <h2 className="text-xl font-bold text-gray-800">Global Complaint Ledger</h2>
                <p className="text-gray-500 mt-2">Monitor all civic issues across all wards in real-time.</p>
                <span className="inline-block mt-4 text-red-600 font-semibold group-hover:translate-x-1 transition-transform">Audit Complaints →</span>
            </Link>

            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 italic flex items-center justify-center text-gray-400">
